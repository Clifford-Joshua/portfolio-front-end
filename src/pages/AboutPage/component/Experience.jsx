  ...
  return (
    <Wrapper>
      <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-[2rem]">
        {/* ========================================================================== */}
        {/* Years of experience */}
        <div className="border-2 rounded-[15px] p-[1rem] lg:p-[1.3rem] flex items-center justify-center gap-[1.5rem]">
          <h2
            className={`${
              isDay ? " text-[#ffd700]" : "text-[#0000ff] "
            } w-[30%] text-[2rem] font-extrabold`}
          >
            {`${years.length <= 9 ? `0${years}` : years} +`}
          </h2>
          <h3 className="w-[45%] text-[1.3rem] lg:text-[1.2rem] font-bold capitalize">
            Years of experience
          </h3>
        </div>
        ...
        <div className="border-2 rounded-[15px] p-[1rem] lg:p-[1.3rem] flex items-center justify-center gap-[1.5rem]">
          <h2
            className={`${
              isDay ? " text-[#ffd700]" : "text-[#0000ff] "
            } w-[30%] text-[2.2rem]  font-extrabold`}
          >
            0 +
          </h2>
          <h3 className="w-[45%] text-[1.3rem] lg:text-[1.2rem] font-bold capitalize">
